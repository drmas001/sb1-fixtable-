...
const ReportGenerationPage: React.FC<ReportGenerationPageProps> = ({ user }) => {
  ...
  const exportToPDF = () => {
    ...
    doc.text('Patient Report', doc.internal.pageSize.width / 2, 25, { align: 'center' });
    
    // Add report info
    doc.setFontSize(12);
    doc.setTextColor(52, 73, 94);
    doc.text(`Generated by: ${user.name}`, doc.internal.pageSize.width / 2, 35, { align: 'center' });
    doc.text(`Period: ${fromDate} to ${toDate}`, doc.internal.pageSize.width / 2, 42, { align: 'center' });
